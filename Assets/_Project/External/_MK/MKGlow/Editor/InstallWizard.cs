...
namespace MK.Glow.Editor.InstallWizard
{
    public sealed class InstallWizard : EditorWindow
    {
        ...
        private static readonly string _version = "4.5.3";
                ...
                */
                {
                    ...
                    switch(_targetRenderPipeline)
                    {
                        ...
                        EditorGUILayout.LabelField("For the URP there are currently only example scenes for the 3D Renderer.", _flowTextStyle);
                        break;
                        case RenderPipeline.High_Definition:
                        break;
                    }
